...
-- Dumping data for table mbkm.fakultas: ~0 rows (approximately)
...
-- Dumping data for table mbkm.jurusan: ~0 rows (approximately)
...
-- Dumping data for table mbkm.mata_kuliah: ~4 rows (approximately)
...
-- Dumping data for table mbkm.migrations: ~12 rows (approximately)
...
INSERT INTO `nilai_mahasiswa_mbkm` (`id`, `paket_id`, `mahasiswa_id`, `nilai_mbkm`, `file_laporan_akhir`, `created_at`, `updated_at`) VALUES
	(1, 1, 2, 86, 'public/file_laporan_akhir/Laporan Akhir_Studi Independen_Muhammad Alamsyah Putra Zatmiko_13119986_Skilvul Challenge Kitabisa.pdf', '2023-08-19 00:12:32', '2023-08-19 00:12:32'),
	(2, 1, 3, 80, NULL, NULL, NULL),
	(3, 2, 4, 92, NULL, NULL, NULL);
...
-- Dumping data for table mbkm.nilai_mahasiswa_perkuliahan: ~8 rows (approximately)
INSERT INTO `nilai_mahasiswa_perkuliahan` (`id`, `mahasiswa_id`, `matkul_id`, `nilai_kuliah`, `nilai_final_kuliah`, `nilai_mahasiswa_mbkm_id`, `created_at`, `updated_at`) VALUES
	(97, 1, 1, 87, NULL, NULL, '2023-09-04 22:18:04', '2023-09-04 22:18:04'),
	(98, 4, 1, 76, 92, 3, '2023-09-04 22:18:04', '2023-09-04 22:21:24'),
	(99, 5, 1, 60, NULL, NULL, '2023-09-04 22:18:04', '2023-09-04 22:18:04'),
	(100, 1, 2, 78, NULL, NULL, '2023-09-04 22:19:57', '2023-09-04 22:19:57'),
	(101, 4, 2, 80, 92, 3, '2023-09-04 22:19:57', '2023-09-04 22:21:24'),
	(102, 5, 2, 95, NULL, NULL, '2023-09-04 22:19:57', '2023-09-04 22:19:57'),
	(103, 1, 3, 78, NULL, NULL, '2023-10-14 23:28:56', '2023-10-14 23:28:56'),
	(104, 4, 3, 100, NULL, NULL, '2023-10-14 23:28:56', '2023-10-14 23:28:56'),
	(105, 5, 3, 98, NULL, NULL, '2023-10-14 23:28:56', '2023-10-14 23:28:56');
...
-- Dumping data for table mbkm.paket_matkul: ~0 rows (approximately)
...
-- Dumping data for table mbkm.semesters: ~1 rows (approximately)
...
-- Dumping data for table mbkm.users: ~2 rows (approximately)
